🕒 Simple Digital Clock A responsive, customizable digital clock built with HTML, CSS, and JavaScript. Includes 12/24-hour format toggle, live date, and tick sound effect on each second.
